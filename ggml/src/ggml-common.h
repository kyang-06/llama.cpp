...
// TQ1_0: 1.6875 bpw ternary, block size QK_K=256
// qs[48] stores 240 elements (5 trits/byte), qh[4] stores 16 elements (4 trits/byte)
// qr = 8: each vec_dot call reads all 8 Q8_1 blocks (256/32) simultaneously
// qi = 8: 8 distinct iqs values cover the full block
#define QR_TQ1_0 8
#define QI_TQ1_0 (QK_K / (4*QR_TQ1_0))
...
// BPT1_0: 128-entry decode table mapping a 7-bit base-3 group index (0..80) to
// four packed signed bytes {-1,0,+1}.  Index = w0 + 3*w1 + 9*w2 + 27*w3.
// Stored as uint32: byte0 = (uint8_t)(w0-1), byte1 = (uint8_t)(w1-1), etc.
// Indices 81..127 are unused and padded with 0.
GGML_TABLE_BEGIN(uint32_t, bpt1_0_decode_lut, 128)
    // w3=0 (indices 0..26)
    0xFFFFFFFF, 0xFFFFFF00, 0xFFFFFF01, 0xFFFF00FF, 0xFFFF0000, 0xFFFF0001, 0xFFFF01FF, 0xFFFF0100,
    0xFFFF0101, 0xFF00FFFF, 0xFF00FF00, 0xFF00FF01, 0xFF0000FF, 0xFF000000, 0xFF000001, 0xFF0001FF,
    0xFF000100, 0xFF000101, 0xFF01FFFF, 0xFF01FF00, 0xFF01FF01, 0xFF0100FF, 0xFF010000, 0xFF010001,
    0xFF0101FF, 0xFF010100, 0xFF010101,
    // w3=1 (indices 27..53)
    ...
    0x00000100, 0x00000101, 0x0001FFFF, 0x0001FF00, 0x0001FF01, 0x000100FF, 0x00010000, 0x00010001,
    0x000101FF, 0x00010100, 0x00010101,
    // w3=2 (indices 54..80)
    0x01FFFFFF, 0x01FFFF00, 0x01FFFF01, 0x01FF00FF, 0x01FF0000, 0x01FF0001, 0x01FF01FF, 0x01FF0100,
    0x01FF0101, 0x0100FFFF, 0x0100FF00, 0x0100FF01, 0x010000FF, 0x01000000, 0x01000001, 0x010001FF,
    0x01000100, 0x01000101, 0x0101FFFF, 0x0101FF00, 0x0101FF01, 0x010100FF, 0x01010000, 0x01010001,
    0x010101FF, 0x01010100, 0x01010101,
    // padding (indices 81..127, unused)
